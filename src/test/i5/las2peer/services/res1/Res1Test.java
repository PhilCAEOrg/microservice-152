 ...
 * 152 - Test Class
 *
 * This class provides a basic testing framework for the microservice 152. It was
...
public class Res1Test {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(Res1.class.getCanonicalName(),"0.1");

  private static final String mainPath = "res1";
  ...
  public void testtestGet() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/test", .toJSONString(),
